 ...
 *
 *  VERSION_HASH: 2120491a006d4982154aabdbfbb1ad41cef5c8220b989d3ebe940d839605c59d
 * 
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: axiosConfig.baseURL || "http://10.180.34.1:19990" });
    this.secure = secure;
    this.format = format;
